...
public:
	...
	//add by Paul Halian
	inline void repeatCallback(MyNoteCallaback* callback);
	inline void finishCallback(MyNoteCallaback* callback);
...
protected:
	...
	// added by Paul Halian
	MyNoteCallaback* _note_is_pressed;
	MyNoteCallaback* _note_is_off;
...
//add by Paul Halian
void Abstract::repeatCallback(CxxMidi::MyNoteCallaback* callback) 
{	
	_note_is_pressed = callback;
}

//add by Paul Halian
void Abstract::finishCallback(CxxMidi::MyNoteCallaback* callback) 
{
	_note_is_off = callback;
}
